...
', N'https://images.pexels.com/photos/5483077/pexels-photo-5483077.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', N'http-requests-javascript', N'AI Generated', CAST(N'2023-06-14T07:40:10.9560000' AS DateTime2), 1)
GO
INSERT [dbo].[BlogPosts] ([Id], [Title], [ShortDescription], [Content], [FeaturedImageUrl], [Slug], [Author], [PublishedDate], [IsVisible]) VALUES (N'908ba10a-f3cd-4918-8c8b-08db6cab4598', N'Building a Simple Web API Using C# and .NET Core: A Step-by-Step Guide', N'Building a robust and efficient web API is a fundamental skill for modern application development. In this comprehensive guide, we will walk you through the process of creating a simple web API using C# and .NET Core.', N'## Introduction
...
', N'https://images.pexels.com/photos/7367/startup-photo.jpg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', N'web-api-csharp', N'AI Generated', CAST(N'2023-06-14T07:45:30.0410000' AS DateTime2), 1)
GO
INSERT [dbo].[BlogPosts] ([Id], [Title], [ShortDescription], [Content], [FeaturedImageUrl], [Slug], [Author], [PublishedDate], [IsVisible]) VALUES (N'9449dc77-3fc4-4b72-8c8c-08db6cab4598', N'Reading an Excel File in C#: A Step-by-Step Guide', N'Reading data from Excel files is a common requirement in many applications. In this comprehensive guide, we will walk you through the process of reading an Excel file in C# using the .NET framework', N'
...
', N'https://images.pexels.com/photos/590022/pexels-photo-590022.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', N'read-excel-csharp', N'AI Generated', CAST(N'2023-06-14T07:48:27.0310000' AS DateTime2), 1)
GO
INSERT [dbo].[BlogPosts] ([Id], [Title], [ShortDescription], [Content], [FeaturedImageUrl], [Slug], [Author], [PublishedDate], [IsVisible]) VALUES (N'061265f3-cdfb-428f-8c8d-08db6cab4598', N'Building a Simple Navigation Bar: A Step-by-Step Guide', N'A navigation bar is an essential component of any website or web application, providing users with easy access to different sections and pages.', N'## Introduction
...
', N'https://images.pexels.com/photos/16037283/pexels-photo-16037283/free-photo-of-open-laptop-on-desk.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', N'html-website-using-chatgpt', N'AI Generated', CAST(N'2023-05-30T22:35:50.6230000' AS DateTime2), 1)
GO
INSERT [dbo].[BlogPosts] ([Id], [Title], [ShortDescription], [Content], [FeaturedImageUrl], [Slug], [Author], [PublishedDate], [IsVisible]) VALUES (N'81495368-62a1-434c-7268-08db615ccdfb', N'Creating a Simple Calculator Application using ASP.NET Core Console App', N'ASP.NET Core is a powerful framework for building cross-platform web applications. While it is commonly used for developing web applications, ASP.NET Core can also be leveraged to create console applications. In this blog post, we will explore in detail how to create a simple calculator application using ASP.NET Core console app. We will cover the step-by-step process of setting up the project, implementing the calculator logic, and running the application. So, let''s get started!', N'## Introduction
...
', N'https://images.pexels.com/photos/1181263/pexels-photo-1181263.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', N'simple-calculator-app-aspnet-core', N'AI Generated', CAST(N'2023-05-30T23:15:59.0570000' AS DateTime2), 1)
GO
